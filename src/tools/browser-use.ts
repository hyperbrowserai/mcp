...
export const browserUseToolDescription = "Perform a certain task inside a browser session. Will perform the entirety of the task inside the browser, and return the results.";